var approvalProcess = {
  "id": "reviewPropertyStatement",
  "name": "Review Property Statement Workflow",
  "version": "1.0",
  "specVersion": "0.7",
  "timeouts": {
    "workflowExecTimeout": {
  ...
  "start": "PropertyStatementSubmission",
  "states": [
    {
      "name": "PropertyStatementSubmission",
      "type": "event",
      "onEvents": [
        {
          "eventRefs": [
            "PropertyStatementSubmissionEvent"
          ],
          "actionMode": "parallel",
          "actions": [
            {
              "name": "Invoke Validate Property Statement Info Function",
              "functionRef": "ValidatePropertyStatementInfo"
            },
            {
              "name": "Invoke Validate Property Owner Info Function",
              "functionRef": "ValidatePropertyOwnerInfo"
            }
          ]
        }
      ],
      "transition": "WaitingForApproval_1"
    },
    {
      "name": "WaitingForApproval_1",
      "type": "switch",
      "dataConditions": [
        {
          "condition": "approved",
          "transition": "WaitingForApproval_2"
        },
        {
          "condition": "rejected",
          "transition": "RejectStatement"
        }
      ],
      "defaultCondition": {
        "transition": "RejectStatement"
    ...
    {
      "name": "WaitingForApproval_2",
      "type": "switch",
      "dataConditions": [
        {
          "condition": "approved",
          "transition": "ApproveStatement"
        },
        {
          "condition": "rejected",
          "transition": "RejectStatement"
    ...
    {
      "name": "ApproveStatement",
      "type": "operation",
      "actions": [
        {
          "name": "Invoke Approve Statement Function",
          "functionRef": "ApproveStatement",
          "sleep": {
            "before": "PT1S"
          }
        }
    ...
    {
      "name": "RejectStatement",
      "type": "operation",
      "actions": [
        {
          "name": "Invoke Reject Statement Function",
          "functionRef": "RejectStatement",
          "sleep": {
            "before": "PT1S"
          }
        }
  ...
  "functions": [
    {
      "name": "ValidatePropertyStatementInfo",
      "type": "rest"
    },
    {
      "name": "ValidatePropertyOwnerInfo",
      "type": "rest"
    },
    {
      "name": "ApproveStatement",
  ...
  "events": [
    {
      "name": "PropertyStatementSubmissionEvent",
...
var examplesMap = {};
examplesMap['approvalProcess'] = approvalProcess;
